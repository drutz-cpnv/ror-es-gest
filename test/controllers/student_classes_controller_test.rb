...
class StudentClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_class" do
    assert_difference("StudentClass.count") do
      post student_classes_url, params: { student_class: { school_class_id: @student_class.school_class_id, student_id: @student_class.student_id } }
    end
  ...
  test "should update student_class" do
    patch student_class_url(@student_class), params: { student_class: { school_class_id: @student_class.school_class_id, student_id: @student_class.student_id } }
